    ...
    return (
        ...
        <View style={styles.postOptionsWrapper}>
            ...
            <TouchableOpacity style={styles.postOptionItemWrapper}>
                <View style={styles.postOptionItem}>
                    <View style={styles.optionIcon}><MaterialCommunityIcons name="facebook-messenger" size={24}></MaterialCommunityIcons></View>
                    <View>
                        <Text style={{
                            fontSize: 17,
                            fontWeight: '700'
                        }}>Nhắn tin cho {lastNameFriend}</Text>
                    </View>
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.postOptionItemWrapper}>
                <View style={styles.postOptionItem}>
                    <View style={styles.optionIcon}><MaterialCommunityIcons name="bookmark-remove-outline" size={24}></MaterialCommunityIcons></View>
                    <View>
                        <Text style={{
                            fontSize: 17,
                            fontWeight: '700'
                        }}>Bỏ theo dõi {lastNameFriend}</Text>
                        <Text style={styles.postOptionTitle}>Không nhìn thấy bài viết của nhau nữa nhưng vẫn là bạn bè</Text>
                    </View>
                </View>
            </TouchableOpacity>
                ...
                <View style={styles.postOptionItem}>
                    ...
                    <View>
                        <Text style={{
                            fontSize: 17,
                            fontWeight: '700'
                        }}>Chặn {lastNameFriend}</Text>
                        <Text style={styles.postOptionTitle}>{lastNameFriend} sẽ không nhìn thấy bạn hoặc liên hệ với bạn trên Facebook</Text>
                    </View>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={onPressUnFriendHandler.bind(this)} style={styles.postOptionItemWrapper}>
                <View style={styles.postOptionItem}>
                    <View style={styles.optionIcon}><MaterialCommunityIcons name="account-remove-outline" size={24}
                        color={'red'}></MaterialCommunityIcons></View>
                    <View>
                        <Text style={{
                            fontSize: 17,
                            fontWeight: '600',
                            color: 'red'
                        }}>Huỷ kết bạn với {lastNameFriend}</Text>
                        <Text style={{
                            fontSize: 16,
                            color: 'red'
                        }}>Xoá {lastNameFriend} khỏi danh sách bạn bè</Text>
                    </View>
                </View>
            </TouchableOpacity>
        </View>
