    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                <View><Text style={styles.tabName}>Menu</Text></View>
                <TouchableOpacity style={styles.searchView}>
                    <Image source={require('@/Assets/Images/SearchIcon.png')} style={styles.searchIcon} />
                </TouchableOpacity>
            </View>
            <TouchableOpacity style={styles.accountContainer}>
                <View style={styles.avatarFrame}><Image source={require('@/Assets/Images/avatar.jpg')} style={styles.avatarImage} /></View>
            ...
            <View style={styles.navbar}>
                <View style={styles.navbar_item}>
                    <TouchableWithoutFeedback onPress={toggleHelpDropdown}>
                        <View style={styles.dropdown_item}>
                            <View style={styles.navbar_item_left_container}>
                                <View><Image source={require('@/Assets/Images/HelpIcon.png')} style={styles.icon_item} /></View>
                                <View><Text style={styles.name_item}>Trợ giúp & hỗ trợ</Text></View>
                            </View>
                            <View>
                                <Animated.Image
                    ...
                    {helpExpanded && (
                        <TouchableOpacity style={styles.item_inside}>
                            <View><Image source={require('@/Assets/Images/BookIcon.png')} style={styles.icon_item_inside} /></View>
                            <View><Text style={styles.name_item_inside}>Điều khoản & chính sách</Text></View>
                        </TouchableOpacity>
                    )}
                </View>
                <View style={styles.navbar_item}>
                    <TouchableWithoutFeedback onPress={toggleSettingsDropdown}>
                        <View style={styles.dropdown_item}>
                            <View style={styles.navbar_item_left_container}>
                                <View><Image source={require('@/Assets/Images/SettingIcon.png')} style={styles.icon_item} /></View>
                                <View><Text style={styles.name_item}>Cài đặt & quyền riêng tư</Text></View>
                            </View>
                            <View>
                                <Animated.Image
                                    source={require('@/Assets/Images/ArrowDown.png')}
                ...
                <TouchableOpacity style={styles.navbar_item}>
                    <View style={styles.navbar_item_left_container}>
                        <View><Image source={require('@/Assets/Images/LogoutIcon.png')} style={styles.icon_item} /></View>
                        <View><Text style={styles.name_item}>Đăng xuất</Text></View>
                    </View>
                </TouchableOpacity>
