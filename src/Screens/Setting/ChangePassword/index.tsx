...
const ChangePasswordScreen = () => {
    ...
    const handleChangePassword = () => {
        if (!changePasswordInfo.currentPassword.trim() || !changePasswordInfo.currentPasswordAgain.trim() ||
        !changePasswordInfo.newPassword.trim() || !changePasswordInfo.newPasswordAgain.trim()) {
            Alert.alert('Lỗi', 'Vui lòng nhập đủ các trường thông tin');
            return;
        }
        if ((changePasswordInfo.currentPassword.length < 6 || changePasswordInfo.currentPassword.length > 10) ||
        (changePasswordInfo.newPassword.length < 6 || changePasswordInfo.newPassword.length > 10)) {
        ...
        if (changePasswordInfo.currentPassword !== changePasswordInfo.currentPasswordAgain ||
    ...
    return (
        <View style={styles.container}>
            <View style={styles.input_container}>
                    ...
                    <TextInput
                        ...
                        right={
                            <TextInput.Icon
                                ...
                                onPress={() => togglePasswordVisibility('currentPassword', !passwordVisible.currentPassword)}
                            />
                        }
                    />
                </View>
                <View>
                    <TextInput
                        ...
                        onChangeText={(text) => handleInputChange('currentPasswordAgain', text)}
                        secureTextEntry={!passwordVisible.currentPasswordAgain}
                        right={
                            <TextInput.Icon
                                icon={passwordVisible.currentPasswordAgain ? 'eye-off' : 'eye'}
                                onPress={() => togglePasswordVisibility('currentPasswordAgain', !passwordVisible.currentPasswordAgain)}
                            />
                        }
                    />
                </View>
                    ...
                    <TextInput
                        ...
                        right={
                            <TextInput.Icon
                                ...
                                onPress={() => togglePasswordVisibility('newPassword', !passwordVisible.newPassword)}
                            />
                        }
                    />
                </View>
                    ...
                    <TextInput
                        ...
                        right={
                            <TextInput.Icon
                                ...
                                onPress={() => togglePasswordVisibility('newPasswordAgain', !passwordVisible.newPasswordAgain)}
                            />
                        }
                    />
                </View>
            ...
            <View style={styles.button_container}>
                <TouchableOpacity onPress={handleChangePassword} style={styles.update_button}>
                    <Text style={{ color: 'white', fontSize: 19, textAlign: 'center' }}>Lưu thay đổi</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => {navigation.navigate('SettingSecurity');}} style={styles.cancel_button}>
