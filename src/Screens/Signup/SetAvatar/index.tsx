...
import { StyleSheet, View, Text, TouchableOpacity, ScrollView, TextInput, Dimensions, Image, Button, SafeAreaView, StatusBar, ImageBackground, Platform } from "react-native";
...
const SetAvatarScreen = () => {
    ...
    const [link, setLink] = useState('https://inkythuatso.com/uploads/thumbnails/800/2023/03/6-anh-dai-dien-trang-inkythuatso-03-15-26-36.jpg');
        ...
        <View style={styles.parentContainer}>
            <View style={styles.navigationBar}>
                <View style={styles.navigationBarLeft}>
                    <Text style={styles.textNavigationBar}>Cập nhật ảnh đại diện của bạn</Text>
                </View>
            </View>
            <View style={styles.container}>
                ...
                >
                    <TouchableOpacity
                        style={styles.btnTemporary}
                        onPress={handleCamera}>
                        <MaterialCommunityIcons name="camera" size={20}></MaterialCommunityIcons>
                ...
                {link !== 'https://inkythuatso.com/uploads/thumbnails/800/2023/03/6-anh-dai-dien-trang-inkythuatso-03-15-26-36.jpg'
                    ? (<TouchableOpacity style={{ ...styles.btn, backgroundColor: "#1877F2" }} onPress={handlePost}>
