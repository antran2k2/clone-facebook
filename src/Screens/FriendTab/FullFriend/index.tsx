...
const FullFriendScreen = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      setData(resquest.data);
      setUserFriends(resquest.data.friends);
      setTotal(resquest.data.total);
    }
  }, [resquest, isSuccess]);
  ...
  const [userFriends, setUserFriends] = useState<Array<TFriend | undefined>>();
    ...
    <View style={styles.container}>
        ...
        <View
          ...
          <View>
            <Text
              ...
              Tất cả bạn bè sẽ xuất hiện ở đây
            </Text>
          </View>
          <TouchableOpacity
            style={{
          ...
          <View style={styles.friends}>
            {userFriends &&
              userFriends.map((friend, index) => (
                <View key={index}>
                  {(friend?.username || '').toLowerCase().indexOf(keyword) >
                  -1 ? (
                    <TouchableOpacity
      ...
      <Modal
        ...
        <FriendOption
          ...
          toggleModalBlock={toggleModal2}
          toggleModalUnFriend={toggleModal3}
        />
      </Modal>
      <Modal
        ...
        <ArrangeWrapper
          sortDataByCreateAt={toggleArrageModal}
          toggleModal={toggleArrageModal}
        />
      </Modal>
      {/* Model AlertBlock */}
      <Modal
