...
const ProfileUserSentRequestScreen = () => {
                ...
                <View style={styles.introWrapper}>
                    ...
                    <View style={styles.introButtonWrapper}>
                        <TouchableOpacity style={styles.btnAddStory}>
                            ...
                            <Text style={{ fontSize: 16, fontWeight: '500', color: '#fff', marginLeft: 5 }}>Đã gửi lời mời</Text>
                        </TouchableOpacity>
...
export default ProfileUserSentRequestScreen;
