...
const EditPublicInfoScreen = () => {
  ...
  const {
    ...
    isSuccess,
    refetch,
  } = useGetUserInfoQuery({user_id: id || '-1'});
      ...
      <ScrollView bounces={false} style={styles.detailsWrapper}>
        ...
        <View style={styles.detail}>
          <View style={styles.detailTitleWrapper}>
            ...
            <TouchableOpacity onPress={onPressChangeCover}>
              <Text style={{fontSize: 16, color: '#318bfb'}}>Chỉnh sửa</Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity activeOpacity={0.8}>
          ...
          <View style={styles.detailTitleWrapper}>
            ...
            <TouchableOpacity
              ...
              <Text style={{fontSize: 16, color: '#318bfb'}}>
                {data?.description ? 'Chỉnh sửa' : 'Thêm'}
              </Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.detail}>
          ...
          <Image
            ...
            style={styles.featured}></Image>
          <View style={styles.detailTitleWrapper}></View>
          <View style={{marginVertical: 12}}>
            <Text style={styles.featuredTxt}>
              Giới thiệu ảnh và tin bạn thích để tất cả bạn bè
            </Text>
